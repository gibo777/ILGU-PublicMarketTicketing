          ...
          children: [
            ...
            TextFormField(
              decoration: InputDecoration(
                hintText: 'APPLICATION SERVER IP AND APPLICATION ID',
                labelText: 'APPLICATION SERVER IP AND APPLICATION ID',
            ...
            Column(
              children: [
                RadioListTile(
                  title: Text('PRODUCTION SERVER (LAN)'),
                  value: 1,
                ...
                SizedBox(height: 2),
                RadioListTile(
                  title: Text('PRODUCTION SERVER (WAN'),
                  value: 2,
                  groupValue: selectedOption,
                  onChanged: (value) {
                    setState(() {
                ...
                SizedBox(height: 2),
                RadioListTile(
                  title: Text('DEVELOPMENT SERVER (MOBILE'),
                  value: 3,
                  groupValue: selectedOption,
                  onChanged: (value) {
                    setState(() {
                ...
                SizedBox(height: 1),
                RadioListTile(
                  title: Text('DEVELOPMENT SERVER (VSO1)'),
                  value: 4,
                  groupValue: selectedOption,
                  onChanged: (value) {
                    setState(() {
